...
def update_book(book_id):
    ...
    # ]):
    if any([
        key in data and not isinstance(data.get(key), type_)
        for key, type_ in [('id', int), ('title', str), ('author', str), ('genre', str), 
                           ('release_year', int), ('series', str), ('read', bool), ('review', str)]
    ]):
        abort(400)
    book={
